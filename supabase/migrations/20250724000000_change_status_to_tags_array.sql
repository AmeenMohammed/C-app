-- Fix database functions to include missing listing_type and status fields
-- This fixes the issue where home page shows incorrect listing type display

-- Update the get_items_within_range function to include listing_type and status
...
-- Update the get_items_within_range_with_blocking function to include listing_type and status
