-- Safe Migration Script for Categories and Items Table Fix
...
-- Step 8: Drop the old category column if it exists
DO $$
BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
...
-- Step 9: Update the get_items_within_range function to use proper join
...
-- Step 11: Test the updated function
...
-- Success message
SELECT '✅ Safe migration completed successfully! Categories are now properly linked to items.' as status;
